    ...
    <>
      <button
        ...
        style={{
          ...
          background: "color-mix(in srgb, var(--gs-surface-elevated) 72%, transparent)",
        ...
        >
          ...
          <aside
            ...
            style={{
              ...
              background: "color-mix(in srgb, var(--gs-surface-elevated) 92%, transparent)",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: isActive ? "#2f250b" : "var(--gs-ink-strong)",
