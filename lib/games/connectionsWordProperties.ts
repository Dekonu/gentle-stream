...
export const WORD_PROPERTIES: Record<string, string[]> = {
  ...
  CROWN:   ["tree", "royalty", "teeth", "head", "verb"],
  ...
  BED:     ["garden", "river", "furniture", "verb"],

  // ── Music ───────────────────────────────────────────────────────────────────
  SHARP:   ["music", "knife", "adjective", "taste"],
  FLAT:    ["music", "tire", "adjective", "apartment"],
  BRIDGE:  ["music", "structure", "card", "nose", "verb"],
  ...
  ROLL:    ["food", "music", "verb", "drum", "dog", "bowling"],
  ...
  ROSE:    ["color", "flower", "verb", "name", "food"],
  ...
  BRIDGE:  ["technology", "music", "structure", "card", "nose", "verb"],
  ...
  BILL:    ["theater", "money", "name", "bird", "verb"],
  ...
  CROWN:   ["body", "royalty", "tree", "teeth", "verb"],
  RIB:     ["body", "food", "verb", "architecture"],
  HEEL:    ["body", "shoe", "bread", "dog", "verb"],
  SHIN:    ["body", "verb"],
